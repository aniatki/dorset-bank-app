...
|----------------|-----|
|<a name="constructor">Explain what a constructor is and when it is used in Python programming language? (5 marks) And give an example in code of this. (5 marks)</a>|10 Marks|
...
[### What is a constructor in Python?] (#constructor)
